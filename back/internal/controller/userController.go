...
func (uc *UserController) GetAllUsers(c *gin.Context) {
	...
	// Prepare response with nested objects and all necessary fields
	...
	for _, user := range users {
		userResponse := map[string]interface{}{
			...
			"Department": map[string]interface{}{
				...
				"supervisorId":       user.Department.SupervisorID,
				"parentDepartmentId": user.Department.ParentDepartmentID,
				"users":              user.Department.Users,
				"calendar":           user.Department.Calendar,
			},
			...
			"salary": map[string]interface{}{
				"ID":                     user.Salary.ID,
				"CreatedAt":              user.Salary.CreatedAt,
				"UpdatedAt":              user.Salary.UpdatedAt,
				"DeletedAt":              user.Salary.DeletedAt,
				"userId":                 user.Salary.UserID,
				"base":                   user.Salary.Base,
				"subsidy":                user.Salary.Subsidy,
				"bonus":                  user.Salary.Bonus,
				"commission":             user.Salary.Commission,
				"other":                  user.Salary.Other,
				"fund":                   user.Salary.Fund,
				"pension_insurance":      user.Salary.PensionInsurance,
				"unemployment_insurance": user.Salary.UnemploymentInsurance,
				"medical_insurance":      user.Salary.MedicalInsurance,
				"housing_fund":           user.Salary.HousingFund,
				"tax":                    user.Salary.Tax,
				"overtime":               user.Salary.Overtime,
				"total":                  user.Salary.Total,
				"is_pay":                 user.Salary.IsPay,
				"salary_date":            user.Salary.SalaryDate,
			},
			"contract": map[string]interface{}{
				"ID":             user.Contract.ID,
				"CreatedAt":      user.Contract.CreatedAt,
				"UpdatedAt":      user.Contract.UpdatedAt,
				"DeletedAt":      user.Contract.DeletedAt,
				"userId":         user.Contract.UserID,
				"contractType":   user.Contract.ContractType,
				"startDate":      user.Contract.StartDate,
				"contractStatus": user.Contract.ContractStatus,
			},
			"files":             user.Files,
