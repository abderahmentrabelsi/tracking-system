...
import { QueryOperation } from './qoreComponents'

export type QoreContext = {
  fetcherOptions: {
    /**
 ...
 */
export function useQoreContext<
  TQueryFnData = unknown,
  TError = unknown,
  TData = TQueryFnData,
  TQueryKey extends QueryKey = QueryKey
>(_queryOptions?: Omit<UseQueryOptions<TQueryFnData, TError, TData, TQueryKey>, 'queryKey' | 'queryFn'>): QoreContext {
  return {
    fetcherOptions: {},
    queryOptions: {},
    queryKeyFn
