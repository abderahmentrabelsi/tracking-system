...
import {
  ...
  InputLabel, FormControlLabel, IconButton, Tooltip, Switch, Snackbar, Dialog, DialogTitle, DialogContent, DialogActions, Button, Badge,
} from '@mui/material';
    ...
    <Box display="flex" flexDirection="column" p={2}>
      ...
      <Box display="flex" flexDirection="row" mb={2}>
        ...
        <Box flexBasis="30%">
          ...
          <EventList events={filteredEvents} handleEventDetailClick={handleEventDetailClick} getEventColor={getEventColor} />
        </Box>
      </Box>
      <EventDialog
        open={open}
      ...
      <Dialog open={eventDetailOpen} onClose={handleEventDetailClose} maxWidth="md" fullWidth>
        ...
        <DialogContent>
          {selectedEventDetail && <EventDetails event={selectedEventDetail} />}
        </DialogContent>
        <DialogActions>
