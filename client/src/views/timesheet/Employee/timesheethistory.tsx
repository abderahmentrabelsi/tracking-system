              ...
              <TableHead>
                <TableRow>
                  <TableCell
                    ...
                    style={{ cursor: 'pointer', borderBottom: `2px solid ${primaryColor}` }}
                  >
              ...
              <TableBody>
                {filteredWorkHours.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map(entry => (
                  <TableRow key={entry.ID} hover>
                    ...
                    {showTaskHistory && (
                      <TableCell>{entry.taskId != null ? getTaskTitle(entry.taskId) : 'N/A'}</TableCell>
                    )}
              ...
              ActionsComponent={paginationProps => (
                <div style={{ flexShrink: 0, marginLeft: 20, display: 'flex', alignItems: 'center' }}>
                  ...
                  <IconButton
                    onClick={event => paginationProps.onPageChange(event, paginationProps.page + 1)}
                    disabled={
                      paginationProps.page >= Math.ceil(paginationProps.count / paginationProps.rowsPerPage) - 1
                    }
                  ...
                  <IconButton
                    onClick={event =>
                      paginationProps.onPageChange(
                        event,
                        Math.max(0, Math.ceil(paginationProps.count / paginationProps.rowsPerPage) - 1)
                      )
                    }
                    disabled={
                      paginationProps.page >= Math.ceil(paginationProps.count / paginationProps.rowsPerPage) - 1
