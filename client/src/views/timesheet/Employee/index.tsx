...
const EmployeeDashboard = () => {
  ...
  const [checkInData, setCheckInData] = useState<CheckInData>({
    ...
    location: 'QORE ENTREPRISES, TUNIS, TUNISIA',
    comments: '',
    taskID: null
  })
            ...
            <CardContent>
              ...
              <Box marginTop={2}>
                ...
                <StyledFormControl fullWidth margin='normal' variant='outlined'>
                  <InputLabel htmlFor='work-type-select' style={{ top: '-10px' }}>
                    Work Type
                  </InputLabel>
                  <Select
                ...
                <CardContent>
                  <Grid container justifyContent='space-between' alignItems='center'>
                    ...
                    <Box display='flex' alignItems='center'>
                      {workTypeIcons[checkIn.workType] || (
                        <WorkOutlineIcon style={{ marginRight: 8, color: 'black' }} />
                      )}
