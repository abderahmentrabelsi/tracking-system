...
const EditRequestForm: React.FC<EditRequestFormProps> = ({ open, onClose, workHours }) => {
  ...
  const handleApprove = async () => {
    try {
      setLoading(true);
      const requestDuration = adjustedCheckin && adjustedCheckout
                ...
                <>
                    ...
                    <Box component="form" sx={{ '& .MuiTextField-root': { mb: 3 }, mt: 4 }}>
                      ...
                      <Box sx={{ display: 'flex', justifyContent: 'space-between', gap: 2 }}>
                        ...
                        <Box sx={{ display: 'flex', flexDirection: 'column', flex: 1 }}>
                          ...
                          <CustomTextField
                            fullWidth
                            value={adjustedCheckin && adjustedCheckout ? `${((adjustedCheckout.getTime() - adjustedCheckin.getTime()) / 3600000).toFixed(2)} hrs` : ''}
                            InputProps={{
                              readOnly: true,
                              startAdornment: (
                                <InputAdornment position="start">
                  ...
                  {activeStep === 1 && (
                    <Box component="form" sx={{ '& .MuiTextField-root': { mb: 5 }, mt: 5 }}>
                      <Typography variant="h6" mb={4}>Manager Comment</Typography>
                      <CustomTextField
