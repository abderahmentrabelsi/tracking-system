...
import { Card, CardContent, Typography, Grid, Box, IconButton, Divider, LinearProgress, useTheme } from '@mui/material'
      ...
      >
        <CardContent>
          <Grid container spacing={2} alignItems='center'>
            <Grid item xs={3}>
              {user.picture ? (
                <Avatar src={user.picture} alt={`${user.firstName} ${user.lastName}`} round size='60' />
              ) : (
                <Avatar
