  ...
  return (
    ...
    >
        ...
        <Box sx={{ marginTop: '20px', textAlign: 'center' }}>
          {loading ? (
            ...
            <Box sx={{ textAlign: 'center', marginTop: '20px' }}>
              <Typography variant="subtitle1" color="textSecondary">No tasks assigned</Typography>
              <CreateTaskForm
                assigneeId={user.ID}
            ...
            <>
              ...
              <Grid container spacing={1} justifyContent="center" alignItems="center" sx={{ marginTop: '20px' }}>
                <Grid item><Typography sx={{ color: '#ca5555' }}>Pending</Typography></Grid>
                <Grid item><Typography sx={{ color: '#0f5b90' }}>In Progress</Typography></Grid>
                <Grid item><Typography sx={{ color: '#b79c5b' }}>Completed</Typography></Grid>
                <Grid item><Typography sx={{ color: '#28922d' }}>Approved</Typography></Grid>
              </Grid>
            </>
          )}
        </Box>
      ...
      <Dialog open={open} onClose={handleClose} maxWidth="md" fullWidth>
        ...
        <DialogContent>
          <TaskList tasks={tasks} onTaskClick={handleTaskClick} onTaskCreated={handleTaskCreated} assigneeId={user.ID} departmentId={departmentId} managerId={managerId} fetchTasks={fetchTasks} />
        </DialogContent>
        <DialogActions>
      ...
      {selectedTask && (
        <Dialog open={openTaskDialog} onClose={handleCloseTaskDialog} maxWidth="md" fullWidth>
          <DialogContent>
            <TaskDetails task={selectedTask} onTaskDeleted={handleCloseTaskDialog} onTaskUpdated={handleTaskUpdated} fetchTasks={fetchTasks} />
          </DialogContent>
          <DialogActions>
