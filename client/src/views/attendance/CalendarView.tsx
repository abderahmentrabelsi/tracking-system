...
const Event = styled(Paper)(({ theme, status }) => ({
  padding: '5px',
  backgroundColor: status === 'Present' ? theme.palette.success.light : status === 'Half Day' ? theme.palette.warning.light : theme.palette.error.light,
  color: theme.palette.getContrastText(status === 'Present' ? theme.palette.success.light : status === 'Half Day' ? theme.palette.warning.light : theme.palette.error.light),
  borderRadius: '5px',
  textAlign: 'center',
}));
