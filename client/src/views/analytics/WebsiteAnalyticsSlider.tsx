...
const generateDataFromMetrics = (metrics: ControllerAggregateMetrics): DataType[] => {
  const images = [
    '/images/cards/graphic-illustration-1.png',
    '/images/cards/graphic-illustration-2.png',
...
type Props = {
  metrics: ControllerAggregateMetrics
}

const Slides = ({ metrics }: Props) => {
