...
import {
  Typography, Card, CardContent, TextField, List, ListItem, IconButton, Grid, Tooltip, Box, Divider, Snackbar, Alert, Avatar, Dialog, DialogTitle, DialogContent, DialogActions, Button
} from '@mui/material';
  ...
  return (
    <>
          ...
          <Grid container justifyContent="space-between" alignItems="center">
            ...
            <Grid item>
              <Tooltip title="Request Status Change">
                <IconButton onClick={handleRequestStatusChangeClick} sx={{ position: 'absolute', top: '10px', right: '10px' }}>
      ...
      <Dialog open={openWarningDialog} onClose={() => setOpenWarningDialog(false)}>
        ...
        <DialogActions>
          <Button onClick={() => setOpenWarningDialog(false)} color="primary">Close</Button>
        </DialogActions>
      </Dialog>
